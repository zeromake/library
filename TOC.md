...
- [算法](#algorithm)
    - [算法引论：一种创造性方法(扫描,无书签).pdf](#算法引论：一种创造性方法(扫描,无书签).pdf)
    - [算法设计与分析基础  第二版](#算法设计与分析基础  第二版)
    - [编译原理](#编译原理)
- [安卓](#android)
    - [更上一层楼－Android研发工程师高级进阶](#更上一层楼－Android研发工程师高级进阶)
    - [Android高薪之路：Android程序员面试宝典.Cebx](#Android高薪之路：Android程序员面试宝典.Cebx)
    - [深入理解Android：卷I](#深入理解Android：卷I)
    - [深入理解Android:卷II](#深入理解Android:卷II)
- [C语言](#c)
    - [C Primer Plus](#C Primer Plus)
    - [lua源码分析.pdf](#lua源码分析.pdf)
    - [数据结构与算法分析](#数据结构与算法分析)
    - [算法精解](#算法精解)
- [C++语言](#c++)
    - [C++ Primer Plus  第6版  中文版](#C++ Primer Plus  第6版  中文版)
    - [C++Primer 第5版.pdf](#C++Primer 第5版.pdf)
    - [C++并发编程实战](#C++并发编程实战)
    - [Linux多线程服务端编程](#Linux多线程服务端编程)
    - [完美C ++ (第5版)+ C++ Primer中文版清晰扫描，Www.Linuxidc.Com](#完美C ++ (第5版)+ C++ Primer中文版清晰扫描，Www.Linuxidc.Com)
    - [数据结构与算法分析C++描述](#数据结构与算法分析C++描述)
    - [高速上手 C++11/14](#高速上手 C++11/14)
- [css](#css)
    - [Css揭秘](#Css揭秘)
...
- [软件工程](#engineering)
    - [微服务设计](#微服务设计)
    - [持续交付-发布可靠软件的系统方法.pdf](#持续交付-发布可靠软件的系统方法.pdf)
    - [敏捷开发的艺术](#敏捷开发的艺术)
    - [程序员的自我修养](#程序员的自我修养)
...
- [Java](#java)
    ...
    - [疯狂Java讲义  第3版](#疯狂Java讲义  第3版)
- [JavaScript](#javascript)
    - [Chrome扩展及应用开发](#Chrome扩展及应用开发)
    - [Html5权威指南](#Html5权威指南)
    - [JS函数式编程指南](#JS函数式编程指南)
    - [Javascript设计模式与开发实践-扉页](#Javascript设计模式与开发实践-扉页)
...
- [Python](#python)
    - [Python Cookbook 中文版，第 3 版](#Python Cookbook 中文版，第 3 版)
    - [Python核心编程（第二版）](#Python核心编程（第二版）)
    - [Python核心编程（中文第二版）带目录.pdf](#Python核心编程（中文第二版）带目录.pdf)
    - [Python源码剖析](#Python源码剖析)
    - [Python高级编程.pdf](#Python高级编程.pdf)
    - [Violent Python 中文版](#Violent Python 中文版)
    - [《Python Cookbook》第三版中文v2.0.0.pdf](#《Python Cookbook》第三版中文v2.0.0.pdf)
    - [《Python编程实战：运用设计模式、冰法和程序库创建高质量程序》迷你书.pdf](#《Python编程实战：运用设计模式、冰法和程序库创建高质量程序》迷你书.pdf)
    - [流畅的Python](#流畅的Python)
    - [编写高质量代码：改善Python程序的91个建议](#编写高质量代码：改善Python程序的91个建议)
- [安全](#safety)
    - [区块链技术指南](#区块链技术指南)
    - [加密与解密(第3版)](#加密与解密(第3版))
- [工具](#tools)
...
### 深入理解Java虚拟机（第2版）
[📖深入理解Java虚拟机（第2版）](java/深入理解Java虚拟机(第2版).epub) [📥下载](../../info/lfs/objects/9424d6e99f4af31caee5272f0da858c7c94fc262d9a8757aa94a70279e76c91a/深入理解Java虚拟机(第2版).epub)
- 评分　　: 8.0
- 创建人　: 周志明
